...
for m in range(1,models+1): 
    ...
    for s in range(seeds):
        path1 = './S1_xcl1_full_msa/TM-scores/recycles_3/only_TMscores_1j9o_model'+str(m)+'_seed'+str(s)+'_3.txt'
        path2 = './S1_xcl1_full_msa/TM-scores/recycles_3/only_TMscores_2jp1_model'+str(m)+'_seed'+str(s)+'_3.txt'
...
ax.margins(x=0)
plt.legend(title='reference',loc='center left',ncol=4,fontsize=18,title_fontsize=22)
plt.show()

...
for m in range(1,models+1): 
    ...
    for s in range(seeds):
        path1 = './1_xcl1_no_mutation/TM-scores/recycles_3/only_TMscores_1j9o_model'+str(m)+'_seed'+str(s)+'_3.txt'
        path2 = './1_xcl1_no_mutation/TM-scores/recycles_3/only_TMscores_2jp1_model'+str(m)+'_seed'+str(s)+'_3.txt'
...
# Experimental results pie charts
chemokine = [1,0,0]
alternate = [0,1,0]
anc0.append(chemokine)
anc2.append(chemokine)
anc2a.append(chemokine)
anc2b.append(chemokine)
anc2c.append(chemokine)
anc2d.append(chemokine)
anc2e.append(chemokine)
anc2f.append(chemokine)
anc2g.append(chemokine)
anc2h.append(chemokine)
anc2i.append(chemokine)
anc2j.append(chemokine)
anc2k.append(chemokine)
anc2l.append(chemokine)
anc2m.append(alternate)
anc2n.append(chemokine)
anc3.append(alternate)
anc4.append(alternate)
xcl1.append(alternate)
